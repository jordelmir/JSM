...
import { getRaffles, Raffle } from '../api/apiClient'; // Adjust path
import { Alert } from 'react-native'; // For error alerts
import { useTranslation } from 'react-i18next'; // For translation

/**
 * Custom hook to fetch and manage the state of active raffles for the mobile application.
