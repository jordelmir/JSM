...
class QRCodeGenerator(
    private val qrSignatureSecret: String = System.getenv("QR_SIGNATURE_SECRET") ?: throw IllegalArgumentException("QR_SIGNATURE_SECRET environment variable not set")
) {
